...
public interface TurtlebotSensorState extends org.ros.internal.message.Message {
  static final java.lang.String _TYPE = "create_node/TurtlebotSensorState";
  ...
  byte getUserDigitalOutputs();
  void setUserDigitalOutputs(byte value);
  ...
  void setRequestedVelocity(int value);
  int getRequestedRadius();
  void setRequestedRadius(int value);
  int getRequestedRightVelocity();
  void setRequestedRightVelocity(int value);
  int getRequestedLeftVelocity();
  void setRequestedLeftVelocity(int value);
}
